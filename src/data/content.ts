...
const fr = {
  ...
  chain: {
    title: 'La chaîne, de bout en bout',
    note: 'Un seul interlocuteur du premier atelier métier jusqu’au run en production.',
    stages: [
      {
        name: 'Cadrer',
        desc: 'Ateliers métier, règles de gestion, feuille de route priorisée, critères d’acceptation.',
      },
      {
        name: 'Modéliser',
        desc: 'Scoring, segmentation, cohortes, prévision, détection d’anomalies, mesure du ROI.',
      },
      {
        name: 'Industrialiser',
        desc: 'Conteneurisation, versioning, APIs, déploiement, automatisation des flux, contrôles qualité.',
      },
      {
        name: 'Faire vivre',
        desc: 'Monitoring, alerting, gestion des incidents, documentation, transfert aux équipes.',
      },
    ],
  },
  roles: {
...
const en: typeof fr = {
  ...
  chain: {
    ...
    note: 'One counterpart from the first business workshop to the production run.',
    stages: [
      {
        name: 'Frame',
        desc: 'Business workshops, business rules, prioritised roadmap, acceptance criteria.',
      },
      {
        name: 'Model',
        desc: 'Scoring, segmentation, cohorts, forecasting, anomaly detection, ROI measurement.',
      },
      {
        name: 'Industrialise',
        desc: 'Containerisation, versioning, APIs, deployment, workflow automation, quality controls.',
      },
      {
        name: 'Keep alive',
        desc: 'Monitoring, alerting, incident handling, documentation, handover to operations.',
      },
    ],
  },
  roles: {
